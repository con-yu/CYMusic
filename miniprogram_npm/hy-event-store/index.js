...
__DEFINE__(1658289331063, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1658289331064,"./event-store":1658289331065}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1658289331064, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1658289331065, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1658289331064,"./utils":1658289331066}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1658289331066, function(require, module, exports) {
...
return __REQUIRE__(1658289331063);
})()
